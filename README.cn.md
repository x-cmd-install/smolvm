...
[![x-cmd/install — smolvm Code Quality Monitoring Repo Card](https://repo.x-cmd.io/smolvm.svg?lang=zh)](https://x-cmd.com/install/smolvm)
...
合计: **184,726** 行代码（覆盖前 5 种语言、共 **379** 个文件）。
